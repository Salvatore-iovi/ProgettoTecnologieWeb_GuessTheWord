var cont=3//variabile che indica il numero di volte che si possono usare i suggerimenti
var tentativi=3
function controlloRisposta() {
    let risposta_esatta = "batofobia"
...
function openSuggerimenti() {
  ...
  /*  function assegnaMonete() {
    ...
    {
        document.getElementById("myfinepartitapopup").style.display = "block"
    }
    function closeFinePartita()
    {
        document.getElementById("myfinepartitapopup").style.display = "none"
    }